        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="title" value="${notice.title}" lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="author" value="${notice.author}" lay-verify="required" placeholder="请输入标题"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item layui-col-xs9 ">
                ...
                <div class="layui-input-block">
                    <textarea type="text" name="content" lay-verify="required" class="layui-input" style="width: 300px; height: 100px;">${notice.content} </textarea>   </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
